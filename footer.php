				...
				<div class="col-lg-3 col-lg-offset-1 col-md-4 col-sm-12 col-sm-offset-0 col-xs-12">
					...
					<div class="widget w-follow">
						<ul>
							...
							<li><a class="utouch-icon" href="https://www.instagram.com/vinnovatetechnologies/" title="Instagram">
	...
	<div class="sub-footer">
		...
		<div class="container">
			<div class="row">
                ...
                <span>
                    <a href="#">Copyright © 2019 Designed & Developed by vInnovate Technologies</a>
                </span>
				</div>
			</div>
		</div>
