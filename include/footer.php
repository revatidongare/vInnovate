      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="widget w-info">
          <div class="site-logo">
            ...
            <div class="logo-text">
              <img src="img/vNewLogo.png" alt="Utouch" class="logo-size">
      ...
      <div class="col-lg-3 col-lg-offset-1 col-md-3 col-sm-12 col-sm-offset-0 col-xs-12" style="margin:0;">
        <div class="widget w-list" style="padding-left: 2.5rem;">
          ...
          <ul class="list list--primary">
            ...
            <li>
              <a href="retreat-project.php">Solutions</a>
              <svg class="utouch-icon utouch-icon-arrow-right">
                <use xlink:href="#utouch-icon-arrow-right"></use>
              </svg>
            </li>
            <li>
              <a href="job-career.php">Jobs and career</a>
              <svg class="utouch-icon utouch-icon-arrow-right">
                <use xlink:href="#utouch-icon-arrow-right"></use>
              </svg>
            </li>
            <li>
              <a href="social-event.php">Social Event</a>
              <svg class="utouch-icon utouch-icon-arrow-right">
                <use xlink:href="#utouch-icon-arrow-right"></use>
              </svg>
            </li>
      ...
      <div class="col-lg-3 col-lg-offset-1 col-md-3 col-sm-12 col-sm-offset-0 col-xs-12" style="margin:0;">
        ...
        <div class="widget w-follow">
          <ul>
            ...
            <li>
              <a href="https://www.facebook.com/vinnovatetechnologies/"><svg class="utouch-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
            ...
            <li>
              <a href="https://twitter.com/VinnovateTechn1"><svg class="utouch-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
            ...
            <li><a class="utouch-icon" href="https://www.instagram.com/vinnovate_technologies/" title="Instagram">
            ...
            <li><a class="utouch-icon" href="https://www.linkedin.com/company/vinnovate-technologies" title="LinkedIn">
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <span>
            <b>Copyright © 2019 Designed & Developed by <a href="#">vInnovate Technologies</a></b>
          </span>
        </div>
      </div>
    </div>
